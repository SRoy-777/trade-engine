...
async def main():
    nifty401_450_csv = backend_dir.parent / "market_data" / "history" / "nifty_401-450" / "nifty_401-450.csv"
    if not nifty401_450_csv.exists():
        print(f"ERROR: Nifty 401-450 symbols list not found at: {nifty401_450_csv}")
        sys.exit(1)
        
    market_dir = backend_dir.parent / "market_data" / "history" / "nifty_401-450"
    market_dir.mkdir(parents=True, exist_ok=True)
    
    # Read symbols
    symbols = []
    with open(nifty401_450_csv, mode="r", encoding="utf-8") as f:
        reader = csv.reader(f)
    ...
    # Save mapping
    mapping_csv = backend_dir.parent / "market_data" / "nifty401_450_security_ids.csv"
