...
async def main():
    nifty451_500_csv = backend_dir.parent / "market_data" / "history" / "nifty_451-500" / "nifty_451-500.csv"
    if not nifty451_500_csv.exists():
        print(f"ERROR: Nifty 451-500 symbols list not found at: {nifty451_500_csv}")
        sys.exit(1)
        
    market_dir = backend_dir.parent / "market_data" / "history" / "nifty_451-500"
    market_dir.mkdir(parents=True, exist_ok=True)
    
    # Read symbols
    symbols = []
    with open(nifty451_500_csv, mode="r", encoding="utf-8") as f:
        reader = csv.reader(f)
    ...
    # Save mapping
    mapping_csv = backend_dir.parent / "market_data" / "nifty451_500_security_ids.csv"
